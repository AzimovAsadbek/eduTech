    ...
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: 72, background: "#ffffff", position: "relative", fontFamily: "sans-serif" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ display: "flex", fontSize: 40, fontWeight: 800, letterSpacing: -2, color: "#111" }}>
            <span>Edu</span>
            <span style={{ color: "#FF6B1A" }}>Tech</span>
          </div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <div style={{ fontSize: 88, fontWeight: 800, letterSpacing: -4, lineHeight: 1, color: "#111", display: "flex", flexWrap: "wrap", gap: 20 }}>
            <span>Kelajak kasblarini</span>
            <span style={{ color: "#FF6B1A" }}>bugundan</span>
            <span>oʻrganing.</span>
          </div>
