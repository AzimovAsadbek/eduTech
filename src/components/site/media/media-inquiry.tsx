      ...
      <div className="container-x relative grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-5">
          ...
          <h2 id="inquiry-title" className="t-h1">
            Loyihangizni <span className="text-orange">muhokama qilamiz.</span>
          </h2>
          <p className="t-lead mt-5 max-w-md text-white/70">Qisqacha yozing: nima kerak, qaysi muddatda. 24 soat ichida taklif va taxminiy byudjet bilan javob beramiz.</p>
        ...
        <div className="glass rounded-(--radius-xl) p-6 sm:p-8 lg:col-span-7">
          <LeadForm type="MEDIA" services={services} defaultServiceSlug={defaultServiceSlug} source={defaultServiceSlug ? `service:${defaultServiceSlug}` : "media:inquiry"} submitLabel="Soʻrov yuborish" dark />
        </div>
      </div>
    </section>
  );
